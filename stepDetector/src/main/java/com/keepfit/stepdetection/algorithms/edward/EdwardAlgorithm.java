...
public class EdwardAlgorithm {
    ...
    public void notifyGravitySensorChanged(long eventTime, double xGravity, double yGravity, double zGravity) {
    ...
    public AccelerationData getAccelerationData() {
        return new AccelerationData(xAcceleration, yAcceleration, zAcceleration, 0);
    }
